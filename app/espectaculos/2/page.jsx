...
export default function Page() {
  return (
    <div className="container w-50 my-5">
      <h1 className="fs-1" style={{ color: '#d1510f' }}>YIDDÁ ESLAVA Y JULIÁN ZUCCHI TERMINAN SU RELACIÓN TRAS 11 AÑOS</h1>
      <div className="fs-5">
        <p>
        En una inesperada noticia compartida en sus redes sociales, el actor Julián Zucchi y la actriz Yiddá Eslava confirmaron el fin a su relación de más de 11 años, la cual comenzó durante su participación en el desaparecido reality ‘Combate’ de ATV.
        </p>
        ...
        <p>
        Aunque terminaron su vínculo como pareja, enfatizaron que seguirán manteniendo una relación cordial por el bien de sus dos pequeños. Su amistad y rol de padres continúa intacto.
        </p>
        <div className="d-flex justify-content-center my-5">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/FFMLg0WRQaY?si=HVhfeJQOIMEhk1TB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        ...
        <p>
        “Nosotros éramos amigos y de repente una noche dejamos de ser amigos”, empezó a contar Julián, siendo interrumpido por Yiddá. “Y al día siguiente tú estás pelotudo. Tú estabas idiota. Idiota total”, contó la artista en su programa ‘Cosa seria’.
        </p>
        <p>
